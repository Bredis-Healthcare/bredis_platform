...
const NewMainPage = () => {
    ...
    return (
        <div className="1 w-[1667px] h-[1072px] relative bg-neutral-100">
            ...
            <div className=" w-[1222px] h-[737px] left-[223px] top-[231px] absolute bg-neutral-100 shadow" />
            <div className=" w-[116px] h-[35px] left-[997px] top-[383px] absolute">
            ...
            <div className=" w-[1105px] h-[671px] left-[300px] top-[265px] absolute">
                <div className="SimoaPtau181AdvantageV214 left-0 top-[40px] absolute text-black text-2xl font-bold">SIMOA pTau181 Advantage v2.1 외 4건</div>
                <div className="Ab40Ab42GfapNflPtau181 left-0 top-[124px] absolute text-black text-xl font-normal">Ab40, Ab42, GFAP, NFL, pTAU181 혈액검체 검사 의뢰</div>
                <div className="0503111932 left-[624px] top-[35px] absolute text-black text-2xl font-light">2023.05.03 11:19:32</div>
                <div className="38262070 left-[897px] top-[595px] absolute text-black text-[32px] font-medium">₩38,262,070</div>
                <div className=" left-[933px] top-[34px] absolute text-lime-500 text-2xl font-bold">검체 인수 완료</div>
                <div className="987204 left-0 top-[10px] absolute text-zinc-500 text-lg font-normal">202308181119-987204</div>
                ...
                <div className=" w-24 h-6 left-0 top-[170px] absolute">
                    <div className="ExpandDownLight w-6 h-6 left-[72px] top-0 absolute flex-col justify-start items-start inline-flex" />
