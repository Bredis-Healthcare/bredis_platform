...
function QuotationRequest (props) {
    ...
    return (
        <div className="top-[-150px] relative">
            <div className="Rectangle30 w-[1100px] h-[1200px] left-[300px] top-[363px] absolute bg-white shadow" />

            <div className="relative left-[10px] h-[500px]">
