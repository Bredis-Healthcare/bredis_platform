function TableCell(props) {
    ...
    return (
        <td style={{maxWidth: maxWidth, minWidth: minWidth, backgroundColor: '#fff', borderColor: '#ccc', color:'#333', borderStyle: 'solid', borderWidth: '1px', fontFamily: 'Arial sansSerif',  fontSize: '14px',
