    ...
    <div>
        <Layout menuName = "홈">
                ...
                <div children="w-full h-full justify-center items-center">
                 ...
                 :
                <div className="bg-white flex-col relative justify-start items-center gap-[200px] inline-flex w-full  pb-[300px] mt-[-2.5rem] mb-[-40px]">
                  <div className="w-full  bg-gray-200 relative aspect-video ">
                      ...
                      <div className="left-[10%] bottom-[10%] absolute">
                        ...
                        <span className="text-whit   e text-6xl font-bold ">DIS</span>
                  ...
                  <div className="w-[90%] flex-col justify-start items-center gap-[78px] inline-flex">
                    ...
                    <div className="w-[100%] relative">
                      ...
                      <div className="w-[100%] top-[10%] absolute justify-center items-center gap-[5%] inline-flex ">
                        <div className="w-[20%] aspect-square bg-sky-100 rounded-full flex flex-col justify-center items-center overflow-visible ">
                            <div className="m-4 lg:text-4xl md:text-2xl font-bold ">서비스 기획</div>
                            <div className="m-4 text-neutral-400 text-center lg:text-lg md:text-base font-bold ">연구분석 목적에 꼭 맞는 분석 서비스를 제안드립니다.</div>
                        </div>
                        <div className="w-[20%] aspect-square bg-sky-100 rounded-full flex flex-col justify-center items-center overflow-visible">
                            <div className="m-4 lg:text-4xl md:text-2xl font-bold ">검체 수거</div>
                            <div className="m-4 text-neutral-400 text-center lg:text-lg md:text-base  font-bold ">전문인력이 안전하고 정확하게 분석대상 검체를 수거합니다.</div>
                        </div>
                        <div className="w-[20%] aspect-square bg-sky-100 rounded-full flex flex-col justify-center items-center overflow-visible">
                            <div className="m-4 lg:text-4xl md:text-2xl font-bold ">연구분석</div>
                            <div className="m-4 text-neutral-400 text-center lg:text-lg md:text-base  font-bold ">온습도, 청정도가 통제된 클린룸 환경에서 정밀하게 분석합니다.</div>
                        </div>
                        <div className="w-[20%] aspect-square bg-sky-100 rounded-full flex flex-col justify-center items-center overflow-visible last:gap-0">
                            <div className="m-4 lg:text-4xl md:text-2xl font-bold ">결과보고</div>
                            <div className="m-4 text-neutral-400 text-center lg:text-lg md:text-base font-bold ">분석결과 Raw Data와 <br/>연구분석 목적에 따른 추가분석을 제공합니다.</div>
                        </div>
                      </div>
                    </div>
                    <div className="w-[90%] h-[45px] justify-center items-start gap-[15%] inline-flex text-white lg:text-3xl md:text-xl font-bold">
                      <div className="w-[20%] h-[3rem] bg-zinc-300 rounded-[10px] flex items-center justify-center ">1-2 weeks</div>
                      <div className="w-[40%] h-[3rem] bg-zinc-300 rounded-[10px] flex items-center justify-center ">2-4 weeks</div>
                      <div className="w-[20%] h-[3rem] bg-zinc-300 rounded-[10px] flex items-center justify-center ">3 days</div>
                    </div>
                  </div>
                  <div className="w-[90%] h-[3px] bg-zinc-400 opacity-60"/>
                  <div className="w-[90%] justify-center items-start lg:gap-[6%] md:gap-20 flex lg:flex-row md:flex-col  break-keep">
                    <div className="lg:w-[30%] md:[90%]  flex-col justify-center items-center gap-6 inline-flex relative">
                      ...
                      <div className="w-[100%] p-4 rounded-2xl border-2 border-zinc-400 flex-col justify-center items-center gap-[20px] flex">
                          <div className="text-center text-neutral-500 lg:text-base md:text-2xl font-bold">글로벌 Top Journal 개제 논문 연구 참여 경험 다수 의료기관, 연구기관, 대학, 기업과 다양한 연구협력 경험</div>
                    ...
                    <div className="lg:w-[30%] md:[90%]  flex-col justify-center items-center gap-6 inline-flex relative">
                      ...
                      <div className="w-[100%] p-4 rounded-2xl border-2 border-zinc-400 flex-col justify-center items-center gap-[20px] flex">
                          <div className="text-center text-neutral-500 text-base md:text-2xl font-bold">자체 전문인력으로 구성된 분석팀 보유<br/>제조사 국내 영업점 공인 국내 독보적 최고수준 <br/>Qualification 장비 자체보유 (2023.07 Qual. 기준)</div>
                    ...
                    <div className="lg:w-[30%] md:[90%]  flex-col justify-center items-center gap-6 inline-flex relative">
                      ...
                      <div className="w-[100%] p-4 rounded-2xl border-2 border-zinc-400 flex-col justify-center items-center gap-[20px] flex">
                          <div className="text-center"><span className="text-neutral-500 text-base md:text-2xl font-bold ">자체보유 임상데이터 기반 데이터분석모형 보유<br/></span><span className="text-neutral-500 text-[10px] font-bold font-['Inter']">(알츠하이머병 및 인지기능 장애 관련 1,000명 이상 데이터 기반)</span></div>
                  ...
                  <div className="w-[90%] h-[3px] bg-zinc-400 opacity-60"/>
                  <div className="w-[90%] flex-col justify-start items-center gap-[50px] inline-flex">
                    <div className="text-center text-black lg:text-5xl md:text-3xl font-bold break-keep">국내외 상급종합병원에 서비스를 공급하고 있으며 다양한 방식으로 연구기관, 의료기관, 글로벌 기업과 협업하고 있습니다</div>
