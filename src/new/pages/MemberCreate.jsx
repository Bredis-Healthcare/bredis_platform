...
function MemberCreate() {
    ...
    return <Layout menuName="회원가입">
        <div className="2 w-[1667px] h-[1100px] relative bg-neutral-100">
            ...
            <input id="email" type="email" rows="1" value={email} onChange={(e) => setEmail(e.target.value)} className="resize-none left-[470px] top-[30px] relative block p-2.5 mb-3 w-[633px] text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="example@bredis.co.kr"></input>
            {!isValidEmail && email && 
