                                ...
                                <>
                                    {
                                        data.status === 'QUOTATION_SUGGESTED' ? (
                                            <button alwaysOn className=" w-[114px] h-[35px] left-[1113px] top-[1420px] absolute">
                                            ...
                                            <button alwaysOn className=" w-[114px] h-[35px] left-[1263px] top-[1430px] absolute"
                                    ...
                                    <button alwaysOn className=" w-[106px] h-[35px] left-[1140px] top-[1430px] absolute"
