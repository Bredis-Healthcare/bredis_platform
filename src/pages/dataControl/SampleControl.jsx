...
const SampleDataGrid = () => {
    ...
    const [columnDefs, setColumnDefs] = useState([
        ...
        { headerName: "박스", field: "boxInfo", filter: "agTextColumnFilter", hide:false, width: 100 },
        ...
        { headerName: "추가인식자1", field: "additional_column1", filter: "agTextColumnFilter", hide:true, width: 100 },
        { headerName: "추가인식자2", field: "additional_column2", filter: "agTextColumnFilter", hide:true, width: 100 },
        { headerName: "추가인식자3", field: "additional_column3", filter: "agTextColumnFilter", hide:true, width: 100 },
        { headerName: "추가인식자4", field: "additional_column4", filter: "agTextColumnFilter", hide:true, width: 100 },
    ...
    const [joinColumnDefs , setJoinColumnDefs ] = useState([
        ...
        { headerName: "id", field: "h_id", hide:true, cellStyle: nonEditableCellStyle, suppressMovable: true },
        { headerName: "키트종류", field: "h_kit_type", filter: "agDateColumnFilter" ,width: 100,suppressMovable: true },
        { headerName: "키트번호", field: "h_kit_number", filter: "agTextColumnFilter", width: 100,suppressMovable: true},
        { headerName: "사용날짜", field: "h_use_date", filter: "agTextColumnFilter", width: 150,suppressMovable: true },
        { headerName: "분석자", field: "h_analyst", filter: "agTextColumnFilter", width: 100,suppressMovable: true},
        { headerName: "사용 용량(μl)", field: "h_usedVolume", filter: "agNumberColumnFilter", width: 150,suppressMovable: true},
        { headerName: "희석 배율", field: "h_dilution_rate", filter: "agNumberColumnFilter",  width: 150,suppressMovable: true},
        { headerName: "메모", field: "h_memo", hide:false, width: 300,suppressMovable: true },
    ]);
