                                    ...
                                    <div key={order.id}>
                                        {index === 0 ? (<div />) : (
                                            <div>
                                                ...
                                                <div className={`w-[1114px] h-[0px] left-[37px] top-[0px]] relative border-[0.5px] border-zinc-400`} />
                                                <div className="h-5"></div>
                                            </div>
                                        )}
                                            ...
                                            </div>
                                            {
                                                order.unreadCustomerMessages > 0 ? (
                                                    <div className="UnreadNoti">
                                                        ...
                                                        <div className="1 left-[800px] top-[150px] absolute text-zinc-500 text-lg font-normal font-['Inter']">읽지 않은 메시지가 {order.unreadCustomerMessages}건 있습니다.</div>
                                                    </div>
                                                ) : (<div />)
                                            }
                                        </div>
